...
describe('Inbox Testing', () => {
  ...
  beforeEach(async () => {
    ...
    inboxContract = await new web3.eth
      .Contract(JSON.parse(interface)) // tells web3 what methods an inbox/this contract has
      .deploy({ data: bytecode, arguments: [INITIAL_MESSAGE] }) // tells web3 to create new contract/ transaction object
